 ...
 *
 * Float and hover crossfade are CSS rather than Framer Motion, because this sits
 * in the LCP region and must not depend on hydration to be visible.
 */
export default function Avatar() {
  ...
  return (
    <div className="relative h-36 w-36 shrink-0 sm:h-40 sm:w-40 md:h-48 md:w-48">
      {failed ? (
        <div
